...
| [20 - Valid Parentheses](20-valid-parentheses/attempt01/README.md) | attempt01 | Successful attempt | Opening brackets added to a stack, the closing bracket is checked via retrieving the opening bracket from the stack and retrieving the matching bracket using a hashmap. |
...
| [217 - Contains Duplicate](217-contains-duplicate/attempt01/README.md) | attempt01 | In Progress | In progress |
